<template>
    <div>
        <Modal v-model:modelValue="showModalNuevo">
            <RegisterItemView @on-register="onRegister($event)" />
        </Modal>
        <Modal v-model:modelValue="showModalEdit">
            <EditItemView @on-update="onUpdate($event)" :item="itemToEdit" />
        </Modal>
...
export default {
    ...
    methods: {
        ...
        getList() {
            const vm = this;
            this.axios.get(this.baseUrl + "/items?q=" + this.textToSearch)
